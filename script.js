...
function getPasswordOptions() {
    lenght = prompt("Please select the lenght of your password, between 8 and 128 characters.");
...
function writePassword() {
    let lenght = prompt("Please select the lenght of your password, between 8 and 128 characters.");
    if (lenght !== null) {
        if (lenght > 128) {
